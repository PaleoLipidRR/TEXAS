...
## Zenodo software DOI (for citation)

For academic citation alongside the paper:

1. Go to [zenodo.org](https://zenodo.org) and link your GitHub account
2. In Zenodo, enable the `TEXAS` repository under "GitHub"
3. Create a GitHub Release (not just a tag) — Zenodo auto-archives it
4. Copy the DOI badge and add it to:
   - `README.md`
   - `CITATION.cff` → `doi: 10.5281/zenodo.XXXXXXX`
