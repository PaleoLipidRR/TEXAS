...
//   Instead of fitting culture + mesocosm + coretop data jointly, this model uses 
//   SUMMARY STATISTICS from the culmeso posterior as fixed hyperpriors for the coretop parameters.
