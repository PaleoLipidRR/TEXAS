...
- **Analysis Date**: August 25, 2025 at 17:50:23
- **Dataset**: texas_genome
- **Total Cultures Analyzed**: 25
- **Success Rate**: 100% (all cultures classified)
- **Phylogenetic Method**: GTDB-Tk v2.4.1 with GTDB r220 database
- **Marker Gene Set**: 53 archaeal-specific proteins (AR53) - **Archaea domain**
...
- **Thermoproteota**: 24 cultures
- **Thermoplasmatota**: 1 cultures

### Class Distribution:
- **Nitrososphaeria**: 17 cultures
- **Thermoprotei_A**: 5 cultures
- **Thermoprotei**: 2 cultures
- **Thermoplasmata**: 1 cultures

### Complete Culture List:

| Genome Accession | Species/Taxon |
|------------------|---------------|
| GCA_000016605.1 | *Metallosphaera sedula* |
| GCA_000200715.1 | *Cenarchaeum symbiosum* |
| GCA_000204585.1 | *Nitrosarchaeum limnae* |
| GCF_000007005.1 | *Saccharolobus solfataricus* |
| GCF_000018465.1 | *Nitrosopumilus maritimus* |
| GCF_000144915.1 | *Acidilobus saccharovorans* |
| GCF_000190315.1 | *Vulcanisaeta moutnovskia* |
| GCF_000193375.1 | *Thermoproteus uzoniensis* |
| GCF_000220175.1 | *Nitrosarchaeum koreense* |
| GCF_000231015.2 | *Desulfurococcus amylolyticus* |
| GCF_000299365.1 | *Nitrosopumilus koreensis* |
| GCF_000303155.1 | *Nitrososphaera gargensis* |
| GCF_000513855.1 | *Desulfurococcus amylolyticus* |
| GCF_000698785.1 | *Nitrososphaera viennensis* |
| GCF_000723185.1 | *Nitrosotenuis uzonensis* |
| GCF_000802205.1 | *Nitrosocosmicus oleophilus* |
| GCF_000812185.1 | *Nitrosopelagicus brevis* |
| GCF_000875775.1 | *Nitrosopumilus piranensis* |
| GCF_000956175.1 | *Nitrosopumilus adriaticus* |
| GCF_002156965.1 | *Nitrosopumilus catalinensis* |
| GCF_013407145.1 | *Nitrosopumilus cobalaminigenes* |
| GCF_013407165.1 | *Nitrosopumilus oxyclinae* |
| GCF_013407185.1 | *Nitrosopumilus ureiphilus* |
| GCF_030518575.1 | *Nitrosotenuis chungbukensis* |
| GCF_900176435.1 | *Picrophilus oshimae* |
...
### File Outputs:
- **Taxonomic Classifications**: `gtdbtk.ar53.summary.tsv` (from GTDB-Tk)
- **Multiple Sequence Alignment**: `alignments/gtdbtk.ar53.user_msa.fasta.gz` (extracted)
- **Reference Tree Placement**: `trees/gtdbtk.ar53.classify.tree` (from GTDB-Tk)  
- **Custom Phylogenetic Tree**: `trees/texas_genome_phylogenetic_tree.newick`
- **Culture Species List**: `texas_genome_species_list.txt`
